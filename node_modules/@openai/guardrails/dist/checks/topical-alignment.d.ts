 ...
 */
export declare const TopicalAlignmentOutput: z.ZodObject<{
 ...
 */
export declare const topicalAlignment: CheckFn<TopicalAlignmentContext, string, TopicalAlignmentConfig>;
