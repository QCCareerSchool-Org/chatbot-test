...
exports.hallucination_detection = exports.HallucinationDetectionOutput = exports.HallucinationDetectionBaseOutput = exports.HallucinationDetectionConfig = void 0;
 ...
 */
exports.HallucinationDetectionBaseOutput = zod_1.z.object({
 ...
 */
exports.HallucinationDetectionOutput = exports.HallucinationDetectionBaseOutput.extend({
 ...
 */
function buildValidationPrompt(includeReasoning) {
    if (includeReasoning) {
...
const hallucination_detection = async (ctx, candidate, config) => {
    ...
    try {
        ...
        tokenUsage = (0, types_1.extractTokenUsage)(response);
        ...
        try {
            ...
            return (0, llm_base_1.createErrorResult)('Hallucination Detection', errorOutput, additionalInfo, tokenUsage);
        }
        // Validate with the appropriate schema
        const selectedSchema = includeReasoning ? exports.HallucinationDetectionOutput : exports.HallucinationDetectionBaseOutput;
