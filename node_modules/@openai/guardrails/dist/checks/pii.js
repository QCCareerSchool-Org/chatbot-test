...
exports._clearDeprecationWarnings = _clearDeprecationWarnings;
 ...
 */
const DEFAULT_PII_ENTITIES = Object.values(PIIEntity).filter((entity) => entity !== PIIEntity.NRP && entity !== PIIEntity.PERSON);
exports.PIIConfig = zod_1.z.object({
    entities: zod_1.z.array(zod_1.z.nativeEnum(PIIEntity)).default(() => DEFAULT_PII_ENTITIES),
    block: zod_1.z
        .boolean()
        .default(false)
 ...
 * @internal
 */
function _clearDeprecationWarnings() {
 ...
 */
function _warnDeprecatedEntities(entities) {
    ...
    for (const entity of deprecated) {
        ...
        const description = entity === PIIEntity.NRP
