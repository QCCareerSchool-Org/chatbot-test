...
(0, vitest_1.describe)('token usage helpers', () => {
    (0, vitest_1.it)('extractTokenUsage returns counts when usage present', () => {
        const usage = (0, types_1.extractTokenUsage)({
            usage: {
                prompt_tokens: 12,
                completion_tokens: 4,
                total_tokens: 16,
    ...
    (0, vitest_1.it)('aggregateTokenUsageFromInfos sums values', () => {
        const summary = (0, types_1.aggregateTokenUsageFromInfos)([
            {
                token_usage: {
                    prompt_tokens: 50,
    ...
    (0, vitest_1.it)('totalGuardrailTokenUsage handles GuardrailResults objects', () => {
        ...
        const totals = (0, types_1.totalGuardrailTokenUsage)({ guardrail_results: guardrailResults });
    ...
    (0, vitest_1.it)('totalGuardrailTokenUsage handles camelCase guardrailResults property', () => {
        const result = (0, types_1.totalGuardrailTokenUsage)({
            guardrailResults: {
                totalTokenUsage: {
                    prompt_tokens: 25,
                    completion_tokens: 10,
