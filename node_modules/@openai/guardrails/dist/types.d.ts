 ...
 */
export declare function extractTokenUsage(response: unknown): TokenUsage;
/**
 * Convert a TokenUsage object into a plain dictionary suitable for serialization.
 */
export declare function tokenUsageToDict(tokenUsage: TokenUsage): TokenUsage;
/**
 * Aggregate token usage values from a collection of guardrail info dictionaries.
 */
export declare function aggregateTokenUsageFromInfos(infoDicts: Iterable<Record<string, unknown> | null | undefined>): TokenUsageSummary;
/**
 * Unified helper to compute total guardrail token usage from any result shape.
 */
export declare function totalGuardrailTokenUsage(result: unknown): TokenUsageSummary;
